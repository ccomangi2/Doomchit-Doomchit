  ...
  function displaylist(row, audio){
    audio.getDownloadURL().then(function(url){
        ...
        let count=0;
                ...
                htmlStr+="<div class='play' id='"+arrNumber[j]+"' ><img src='img/web_playsound.png' alt='play sound button'/></div>";
                j++;
  
        $(".play").click(function(){
            window.open($(this).attr('id'), '둠칫둠칫','height=100,width=180,toolbar=no');
