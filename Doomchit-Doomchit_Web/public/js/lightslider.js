        ...
        plugin = {
            ...
            controls: function () {
                if (settings.controls) {
                    if ($(window).width() > 981) {
                        $el.after(
                            '<div class="lSAction"><a class="lSPrev" ><i class="fas fa-chevron-left" style="font-size:30px; color:black"></i>' +
                                settings.prevHtml +
                                '</a><a class="lSNext">' +
                                settings.nextHtml +
                                '<i class="fas fa-chevron-right" style="font-size:30px; color:black"></i></a></div>'
                        );
                    }
                    ...
                    for (i = 0; i < length; i++) {
                        ...
                        if (settings.gallery === true) {
                            pagers +=
                                ...
                                ":" +
                                settings.thumbMargin +
                                'px"><i class=" fas fa-circle dot_sliders" style="font-size:' +
                                thumbWidth * 0.8 +
                                'px;color:#e6e6e6"></i></li>';
                        } else {
                            pagers +=
                                '<li><a href="#">' + (i + 1) + "</a></li>";
                        }
            ...
            active: function (ob, t) {
                ...
                if (scene * settings.slideMove < length) {
                    ...
                    if (ob.length < 6) {
                        ...
                        for (var i = 0; i <= ob.length - 1; i++) {
                            ob.eq(i).removeClass(
                                "dot_medium dot_small_1 dot_small_2 dot_small_3 active focus inactive"
                            );
                        }
                        if (sc > 0) {
                            var len = ob.length;
