...
import static com.example.doomchit_doomchit.BeatMakingOriginalActivity.BROADCAST_EXTRA_DATA;
import static com.example.doomchit_doomchit.BeatMakingOriginalActivity.BROADCAST_WAVEFORM;

public class RecordingServiceOrigin extends Service {
    public static final String NOTIFICATION_CHANNEL_RECORDING = "channel_recording";
    public static final int NOTIFICATION_ID = 1000;

    public final static String ACTION_STOP = "com.example.doomchit_doomchit.stop";
    ...
    private Notification createNotification() {
        final Intent parentIntent = new Intent(this, BeatMakingOriginalActivity.class);
        parentIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        final Intent targetIntent = new Intent(this, BeatMakingOriginalActivity.class);
