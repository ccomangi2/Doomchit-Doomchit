...
import static com.example.doomchit_doomchit.BeatMakingClassicActivity.BROADCAST_EXTRA_DATA;
import static com.example.doomchit_doomchit.BeatMakingClassicActivity.BROADCAST_WAVEFORM;

public class RecordingServiceClassic extends Service {
    ...
    private Notification createNotification() {
        final Intent parentIntent = new Intent(this, BeatMakingClassicActivity.class);
        parentIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        final Intent targetIntent = new Intent(this, BeatMakingClassicActivity.class);
