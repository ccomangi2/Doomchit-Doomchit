...
import static com.example.doomchit_doomchit.BeatMakingPopActivity.BROADCAST_EXTRA_DATA;
import static com.example.doomchit_doomchit.BeatMakingPopActivity.BROADCAST_WAVEFORM;

public class RecordingServicePop extends Service {
    ...
    private Notification createNotification() {
        final Intent parentIntent = new Intent(this, BeatMakingPopActivity.class);
        parentIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        final Intent targetIntent = new Intent(this, BeatMakingPopActivity.class);
